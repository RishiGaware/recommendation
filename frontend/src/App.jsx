      ...
      {activeTab === "analyze" ? (
        ...
        <div className="section">
          <div className="form-group">
            ...
            <textarea
              style={{ height: "300px", fontFamily: "monospace", fontSize: "0.7rem" }}
          ...
          <button className="btn" onClick={handleExtractData} disabled={loadingReport}>
          ...
          {extractedData && (
            <div className="results-area">
              <div style={{ background: "#f5f5f5", padding: "15px", borderRadius: "4px" }}>
                <h3 style={{ fontSize: "1rem", marginBottom: "10px" }}>Extracted Text</h3>
                <pre style={{ 
                  whiteSpace: "pre-wrap", 
                  fontSize: "0.85rem", 
                  color: "#333",
